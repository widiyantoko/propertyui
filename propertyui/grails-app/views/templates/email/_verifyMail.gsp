                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="padding: 0 0 20px;">
                                            <h3>Selamat Datang di PropertyUI</h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 0 0 20px;">
                                            <br>
                                            Hallo <strong>${user}!</strong> Selamat Datang di PropertyUI
                                            <br>
                                            Klik tautan dibawah untuk verifikasi email anda
                                        </td>
                                    </tr>

                                    <tr>
                                        <td  style="padding: 0 0 20px; text-align: center">
                                            <a href="${verifyEmailLink}" style="color: #fff;background-color: #337ab7;border-color: #2e6da4;">Verifikasi</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
